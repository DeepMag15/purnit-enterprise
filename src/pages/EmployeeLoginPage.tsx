...
import { LayoutDashboard, Mail, Lock, Building2 } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground mt-1">Sign in with your company credentials</p>
      </div>
